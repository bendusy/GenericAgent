"""feishu_hub.bot_role — bots.yaml 加载 + per-bot 事件匹配。

设计契约：

- ``BotRole`` 是不可变 dataclass，从 ``~/.feishu_hub/bots.yaml`` 顶层 ``bots:`` 数组加载
...
from feishu_hub import bot_role as br  # noqa: E402
