"""feishu_hub.daily_report 单测（mock lark_cli + 临时 state）。"""
...
from feishu_hub import config as cfgmod  # noqa: E402
from feishu_hub import daily_report, journal, lark_cli  # noqa: E402
