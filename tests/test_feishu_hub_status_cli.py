...
from feishu_hub import __main__ as fhmain
...
def test_status_prints_identity_section(isolated_home, monkeypatch):
    from feishu_hub import identity as ident
    fake = ident.Identity(
